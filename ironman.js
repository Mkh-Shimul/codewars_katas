/* 
Problem: An Ironman Triathlon is one of a series of long-distance triathlon races organized by the World Triathlon Corporaion (WTC).
...
*/
function iTri(s){
  let totalDistance = 2.4 + 112 + 26.2;
  if(s === 0) {
    return "Starting Line... Good Luck!";  
  } if(s > 0 && s <= 2.4) {
    return {
      "Swim" : `${(totalDistance - s).toFixed(2)} to go!`
    }
  } if(s > 2.4 && s <= 114.4) {
    return {
      "Bike" : `${(totalDistance - s).toFixed(2)} to go!`
    }
  } if(s > 114.4 && s < totalDistance ) {
    return {
      "Run" : `${(totalDistance - s).toFixed(2)} to go!`
    }
  } if(s > (totalDistance - 10) && s < totalDistance) {
    return {
      "Run" : "Nearly there!"
    }
  } if(s >= totalDistance) {
